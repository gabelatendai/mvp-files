...
import 'package:app/components/AppBarWidget.dart';
import 'package:app/components/drawer.dart';
import 'package:app/components/drawerwidget.dart';
import 'package:app/models/ImageUploadModel.dart';
import 'package:app/models/packagesModel.dart';
import 'package:app/screens/New.dart';
import 'package:app/screens/Shipments.dart';
import 'package:app/screens/Utility.dart';
import 'package:app/screens/shipmentspage.dart';
import 'package:app/screens/try.dart';
import 'package:app/shipments.dart';
import 'package:app/utils/sqlite_helper.dart';
...
class _PackagesPageState extends State<PackagesPage> {
  ...
  _getCart() async {
    ...
    for (int i = 0; i < _cartList.length; i++) {
      ...
      print(
          "Product Name: ${cart.name},price: ${cart.dim}, Product Type: ${cart.notes}");
    }
  }
                ...
                child: _cartList == null
                    ...
                    : new ListView.builder(
                        ...
                        itemBuilder: (_, int index) {
                          ...
                          String DecoImage = bunners.image1;
...
class _CustomDialogwState extends State<CustomDialogw> {
  ...
  Future _onAddImageClick(int index) async {
    var pgdimg = ImagePicker.pickImage(source: ImageSource.gallery);
    if (pgdimg == null) return;
    setState(() {
      _imageFile = pgdimg;
      getFileImage(index);
    });
...
//      print("Product Name: ${cart.name },price: ${cart.dim }, Product Type: ${cart.notes}");
  ...
  _add() async {
    ...
    //Uint8List imgString1 = im1.readAsBytesSync();
    ...
    var db = new Helper();
    result = await db.saveSqlCart(new SqlCart(
        "${_controllerdes.text}",
        "${imgString1}",
        "${imgString2}",
        "${imgString3}",
    ...
    if (result != 0) {
      // Success
      _showAlertDialog('Status', 'Package Saved Successfully');
    }
    setState(() {
      _getCart();
    });
